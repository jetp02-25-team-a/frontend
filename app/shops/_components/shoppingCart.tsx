  ...
  return (
    <>
      <Link href={`/shops/cart`}>
        <div className="size-15 bg-white rounded-full flex items-center justify-center fixed bottom-50 right-10 ">
          ...
          <PiShoppingCartSimpleBold className="text-[#F2A922] size-10" />
        </div>
      </Link>
    </>
  );
